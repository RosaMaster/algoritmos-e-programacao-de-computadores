# Exercício 03: Verificação de Login
# Dev: RosaMaster
# Título: Verificação de Login
# Descrição: Implemente um programa que comece pedindo ao usuário para digitar uma identificação
